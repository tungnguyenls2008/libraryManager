    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto topnav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-outline-primary text-black-50" type="button" href="borrow/borrowForm.php" data-toggle="modal" data-target="#myModal">Make new borrow oder</a>
                </li><?php endif; ?>
                <li class="nav-item">
                    <a class="nav-link btn btn-danger text-black-50" type="button" href="logout.php" data-toggle="modal" data-target="#myModal">LOGOUT</a>
                </li>
            </ul>
        </div>
